...
function Fatsil() {
  return (
    <div className="h-screen bg-orange-200 py-32">
    ...
    We would like to acknowledge the Traditional Custodians of the land on which we meet today,
     and pay our respects to their Elders past and present.
     we extend that respect to Aboriginal and Torres Strait Islander peoples viewing the page.
</h2>
      ...
      <p className="mb-16"> and from following the fatsil guidelines we have presented an excerpt below. Containing summaries of topics alongside direct information from the document deemed relevent to this project. </p> 
        ...
        <button
          className="bg-orange-400 rounded-lg   hover:bg-red-500 hover:text-white py-8">
          <a
        ...
        <p className="text-md font-medium text-white-600 py-16 ">
        </p>
        <ul className="list-disc text-bold">
  <li className=" text-white text-bold text-2xl ">Language revitalisation</li>
  <p className="font-xs text-sm ">
    the role of preserving language to pass down to future generations is of vital importantance. The publishing and recording of 
    language resources such as dictionaries grammars and language learning material is vital , with the help of academics and non aboriginal people languages are able to be revitalized </p>
  <li className=" text-white text-bold text-2xl ">Community consultation</li>
  <p className="font-xs text-sm"> 
  The role of community is fundamental as the are the owners and custodians of the languages and creators of the culture to which can be spread to younger generations. In recent times there has been an emergence of indigenous people from within their communities that are researching and teaching their languages , Acting as a connector between linguists and the community  of
  </p>
  <li className=" text-white text-bold text-2xl " >Access to language materials </li>
  <p className="font-xs text-sm"> 
As aboriginal and torres straigt islander communities are the custodians of their culture and language heritage they should be viewed with the utmost respect and should be cherished as consultants in passing on this knowledge they hold
. When it comes to accessing copies of language material, These should be stored in a safe location for sharing however these documents may contain culturally sensitive materials , Thus language centres have created mechanisms to make sure that only  the appropriate people have access to certain material. This is embodied within our website also </p>

<li className=" text-white text-bold text-2xl ">Copyright laws and ownership of content </li>
  <p className="font-xs text-sm"> 
When dealing with storing content ownership is important. copyright only applies ot the original materia, hjowever much traditional indigenous cultural knowledge is passed down from generation to genereation and may not be considered original and at risk of not being protected under copyright laws.
However: as stated :
The model agreement developed by the Arts Law Centre of Australia helps to overcome some of the
difficulties faced to date by communities and their consultants. Where a community works with a
...
people realise that many language publications are produced on a non-profit basis and that often sales
...
language projects skills and knowledge which complement and build on those of the community.</p>
</ul>
</div>
      </div>
